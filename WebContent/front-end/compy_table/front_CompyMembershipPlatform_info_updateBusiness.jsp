        ...
        <div class="info_div">
            ...
            <div class="update_btn">
            	...
            	<form action="<%=request.getContextPath() %>/compy_table/Compy_TableServlet_front" method="post" id="business_form" enctype="multipart/form-data">
            		<input type="file" name="cp_business" id="cp_business" accept="image/*">
            	</form>
            </div>
            <div class="display_div">
            	<img class="info_business_display_img" src="<%=request.getContextPath() %>/compy_table/Compy_TableServlet_front?method=many_pics_display&mail=${authority.cp_contact_email}&which_one=business" alt="公司營業登記證">
            </div>
        </div>
    </div>
