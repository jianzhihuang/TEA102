...
td{
    border-bottom: 100px solid white;padding:100px;
}
tr:nth-child(1){
...
<!--    <div class="content"  style="weight:100px;height:425px;border:3px tomato dashed;"> -->
...
<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/controller/Ad_TableDAOServletFront_End" name="form1" enctype="multipart/form-data">
        ...
        <input type="hidden" name="money" id="money" value="0">
         ...
         <h1>廣告月費制<br>選取每日廣告時段</h1>
         
        <tr>
           <td>廣告是否至頂</td>
          <td><label><input type ="radio" name ="ad_top_yn" value="1">是</label>
           <label><input type ="radio" name ="ad_top_yn" value="0" checked="checked">否</td></label> 
       </tr>
     
        <tr>
            <td class="keyword">購買時段一08:00-16:00</td>
            <td><label><input type ="radio" name ="ad_top_time1" id="time1yes" value="888">是</label>
            <label><input type ="radio" name ="ad_top_time1" id="time1no" value="888" checked="checked">否</<label></td>
            
        </tr>
        <tr>
            <td class="keyword">購買時段二 16:00-24:00</td>
            <td><label><input type ="radio" name ="ad_top_time2"id="time2yes" value="888">是</label>
            <label><input type ="radio" name ="ad_top_time2" id="time2no" value="888" checked="checked">否</label></td>
        </tr>

        <tr>
            <td class="keyword">購買時段三 24:00-08:00</td>
           <td> <label><input type ="radio" name ="ad_top_time3" id="time3yes" value="888">是</label>
           <label> <input type ="radio" name ="ad_top_time3" id="time3no" value="888" checked="checked">否</label></td>
        </tr>
