...
<body>
	...
	<div class="info_div">
        ...
        <div class="update_view">
            <div class="view">
                <div class="view_info">
                    環視圖1<input type="file" name="rs_view1" id="rs_view1">
                </div>
                <div class="img">
            ...
            <div class="view">
                <div class="info">
                    環視圖2<input type="file" name="rs_view2" id="rs_view2">
                </div>
                <div class="img">
            ...
            <div class="view">
                <div class="info">
                    環視圖3<input type="file" name="rs_view3" id="rs_view3">
                </div>
                <div class="img">
            ...
            <div class="view">
                <div class="info">
                    環視圖4<input type="file" name="rs_view4" id="rs_view4">
                </div>
                <div class="img">
            ...
            <div class="view">
                <div class="info">
                    環視圖5<input type="file" name="rs_view5" id="rs_view5">
                </div>
                <div class="img">
