...
<body>
	<div class="btn_1">
		<a
			href="<%=request.getContextPath()%>/front-end/order_table/RS_all_order_page.jsp?method=1">
	...
	<div class="btn_2">
		<a
			href="<%=request.getContextPath()%>/front-end/order_table/RS_complete_order_page.jsp?method=2">
	...
	<div class="btn_3">
		<a
			href="<%=request.getContextPath()%>/front-end/order_table/RS_cancel_order_page.jsp?method=3">
