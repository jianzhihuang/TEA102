...
<body>
	...
	<div class="btn_1">
		<a
			href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_all_page.jsp">
	...
	<div class="btn_2">
		<a
			href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_complete_page.jsp">
	...
	<div class="btn_3">
		<a
			href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_cancel_page.jsp">
