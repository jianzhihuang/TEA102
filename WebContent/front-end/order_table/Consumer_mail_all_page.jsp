...
<body>						
		<div class="btn_1">
			<a href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_all_page.jsp">	
			<input type="button"  value="全部訂單" name="按鈕名稱"></a>
		</div>
		
		<div class="btn_2">
			<a href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_complete_page.jsp">
			<input type="button" value="已成立訂單" name="按鈕名稱" ></a>
		</div>
		
		<div class="btn_3">
			<a href="<%= request.getContextPath()%>/front-end/order_table/Consumer_mail_cancel_page.jsp">
